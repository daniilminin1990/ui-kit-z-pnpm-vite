...
export default [
  {
    ignores: ['dist', 'node_modules'], // Игнорируем dist и node_modules
  },
  {
    files: ['**/*.{js,jsx,ts,tsx}'], // Поддержка файлов JS, JSX, TS, TSX
    languageOptions: {
    ...
    rules: {
      ...
      'react/react-in-jsx-scope': 'off', // Отключаем требование импорта React в JSX-файлах
